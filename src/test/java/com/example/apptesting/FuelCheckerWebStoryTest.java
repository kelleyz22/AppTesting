...
public class FuelCheckerWebStoryTest {
    ...
    public void test_T5() {
        ...
        assertTrue(driver.getPageSource().contains("Standard tank capacity: 1200 litres"));
        assertTrue(driver.getPageSource().contains("High safety tank capacity: 800 litres"));
        driver.findElement(By.id("goback")).click();
        wait.until(ExpectedConditions.titleIs("Fuel Checker"));
    }
    ...
    public void test_T6() {
        ...
        assertTrue(driver.getPageSource().contains("Thank you for using fuelchecker."));
        driver.get(url);
        wait.until(ExpectedConditions.titleIs("Fuel Checker"));
    }
